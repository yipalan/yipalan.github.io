...
* 📸 **官方 Instagram / Active Social Media:** [追蹤 阿美勝 On Instagram @teamamazinghk](https://www.instagram.com/teamamazinghk) *(請認準官方新帳號 **@teamamazinghk** 以獲取最新資訊，舊有帳號 HKADBT 已停止更新並全面停用。)*
...
* **同心向前 (Moving in One Beat):** Fostering a vibrant community that moves together as one crew (*Amazing One!*), achieving excellence on the water while promoting Christian values and mutual trust off the water (*Amazing All in One!*).

## 🛠 技術棧 / Tech Stack
- **Design & Layout:** Figma / HTML5 / Tailwind CSS (Responsive Web Design)
- **Deployment:** GitHub Pages (Subfolder architecture)
- **SEO & Discovery:** Optimized `sitemap.xml` & `robots.txt` targeting local search keywords

## 📁 項目結構 / Project Structure
- `index.html` — 團隊主頁 / Main landing page showcasing our mission, values, and community contact form.
- `amz.mp4` — 團隊精華影片 / High-energy team promotional video asset using relative routing.
...
* **ZH (歷年戰績):** 
  - 2026 香港沙頭角喜馬拉冬蟲草盃 — **冠軍** (沙頭角喜馬拉冬蟲草盃冠軍)
  - 2026 香港荃灣龍舟競渡 — **公開銀盃賽季軍**
...
---
*Maintained by 阿美勝龍舟隊 | Team Amazing*
